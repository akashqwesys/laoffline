              ...
              <div class="card card-bordered card-full">
                ...
                <ul class="nk-activity">
                  <li class="nk-activity-item">
                    <div class="nk-activity-media user-avatar bg-success"><img v-bind:src="c_sm" alt=""></div>
                  ...
                  <li class="nk-activity-item">
                    <div class="nk-activity-media user-avatar bg-purple"><img v-bind:src="d_sm" alt=""></div>
                    <div class="nk-activity-data">
